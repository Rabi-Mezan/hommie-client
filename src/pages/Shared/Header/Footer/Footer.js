...
const Footer = () => {
    return (
        <div className='bg-dark text-left text-white'>
            <div class="container p-4">

                <section class="mb-4">

                    <Link class="btn btn-outline-light  m-1" to="/" role="button"
            ...
            <div class="text-left p-3" style={{ backgroundColor: "rgba(0, 0, 0, 0.2)" }}>
                © 2022 Copyright:
                <span
                    class="text-white" to="https://mdbootstrap.com/">R.dev// Ravi-Mezan</span>
            </div>
