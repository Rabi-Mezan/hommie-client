                    ...
                    <div className='mt-5'>
                        <div className="quality row row-cols-lg-3 row-cols-1">
                            <div className="col my-3">
                                ...
                                <p className='quality-des w-75'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit aspernatur alias assumenda sunt adipisci vel!</p>
                            </div>
                            ...
                            <div className="quality col my-3">
                                <i style={{ color: '#73BF9C' }} className="fas fa-star fw-bold fs-2"></i>
                                <h4 className='my-1 fw-bold'>Luxury</h4>
                                <p className='quality-des w-75'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit aspernatur alias assumenda sunt adipisci vel!</p>
                            </div>
                            <div className="quality col my-3">
                                <i style={{ color: '#73BF9C' }} className="fas fa-dollar-sign fw-bold fs-2"></i>
                                <h4 className='my-1 fw-bold'>Best Price</h4>
                                <p className='quality-des w-75'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit aspernatur alias assumenda sunt adipisci vel!</p>
                            </div>
                            <div className="quality col my-3">
                                <i style={{ color: '#73BF9C' }} className="fas fa-map-marker-alt fw-bold fs-2"></i>
                                <h4 className='my-1 fw-bold'>Strategic Location</h4>
                                <p className='quality-des w-75'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit aspernatur alias assumenda sunt adipisci vel!</p>
                            </div>
                            <div className=" col my-3">
                                <i style={{ color: '#73BF9C' }} className="fas fa-chart-pie fw-bold fs-2"></i>
